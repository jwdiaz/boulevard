...
var imagePart = (function() {
 ...
 var artTitle = new Array();
        artTitle[0] = 'Diagram (1).jpg';
        artTitle[1] = 'Diagram (2).jpg';
        artTitle[2] = 'Diagram (3).jpg';
        artTitle[3] = 'Diagram (4).jpg';
var imageParts = [];
var clicks = 0;
var imageNumber = 0;
var diagramAmount = 3;
...
$(document).ready(function() {
    ...
    imageNumber = Math.floor(Math.random() * diagramAmount);
    load(rows,columns,'images/puzzles/' + artTitle[imageNumber]);
